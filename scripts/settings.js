...
function applySettings() {
    ...
    document.getElementById("skip_confirmation_on_off").checked = currentSettings['skipConfirmation'];
...
function toggleSkipConfirmation(element) {
    currentSettings['skipConfirmation'] = !currentSettings["skipConfirmation"];
    element.checked = currentSettings['skipConfirmation'];
    saveSettings();
}
